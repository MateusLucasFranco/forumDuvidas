...
<div class="flex justify-center min-h-screen">
    <div class="md:w-3/5 w-3/4 px-10 flex flex-col gap-2 p5">
        <div class="flex justify-between">
            ...
            @can('owner', $support->user['id'])
                <form action="route('supports.destroy', $support->id)" method="POST">
                    @csrf()
                    @method('DELETE')
                    <button class="bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded">Deletar</button>
                </form>
            @endcan
        </div>
        ...
        <div class="flex flex-col gap-3 text-white">
            ...
            <div class="py-4">
                <form action="{{route('replies.store', $support->id)}}" method="POST">
                    ...
                    <textarea name="content" rows="2" placeholder="Sua resposta"
